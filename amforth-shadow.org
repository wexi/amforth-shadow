...
words/greek.asm uses the AVR registers ah:al (r7:r6), .. , dh:dl (r13:r12)
as Forth locals. The following example uses three (out of the four
available) greek alphabet named locals. "(3)" loads the locals from stack.

#+BEGIN_EXAMPLE
: sort  ( α=addr β=length γ=order -- ) (3) your-favorite-sort-algo ;
#+END_EXAMPLE
