...
* USART tx/rx isr with RTS/CTS support

Define the following macros in your application main file ("template.asm") as applicable to your project.

#+BEGIN_EXAMPLE
.set WANT_ISR_RX = 1		;interrupt driven receive
.set WANT_ISR_TX = 1		;interrupt driven transmit

#define RXR_SIZE 16		;= 2⁴ receive queue size
#define TXR_SIZE 32		;= 2⁵ transmit queue size
