...
AmForth project was fondly called "HQ" as there was hope that AmForth will
adopt some of AmForth-Shadow ideas/patches.
...
- 0drop  ( X -- 0 ) :: [ASM] Replace top of stack with 0.
