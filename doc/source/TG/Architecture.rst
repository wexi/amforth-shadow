...
+--------------------------+-----------------------------+
| Address offset (cells)   | Purpose                     |
+--------------------------+-----------------------------+
| 0                        | Multitasker Status          |
+--------------------------+-----------------------------+
| 1                        | Multitasker Follower        |
+--------------------------+-----------------------------+
| 2                        | RP0                         |
+--------------------------+-----------------------------+
| 3                        | SP0                         |
+--------------------------+-----------------------------+
| 4                        | SP (used by multitasker)    |
+--------------------------+-----------------------------+
| 5                        | HANDLER (exception handler) |
+--------------------------+-----------------------------+
| 6                        | BASE (number conversion)    |
+--------------------------+-----------------------------+
| 7                        | EMIT (deferred)             |
+--------------------------+-----------------------------+
| 8                        | EMIT? (deferred)            |
