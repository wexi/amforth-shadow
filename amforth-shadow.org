...
+ MARKER maintains wordlist order. Patch submitted to HQ.
...
+ A distiller function :: A --log option has been added to amforth-shell.py to collect the actual code that it sends to the AmForth system.
