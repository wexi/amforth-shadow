...
independent fork of [[http://amforth.sourceforge.net/][AmForth]] since its trunk@1687 (where AmForth has changed
its license from GPLv2 to GPLv3). AmForth-Shadow is maintained by an
experienced embedded systems programmer, yet a novice[fn:1] in Forth. The
following summarizes the Shadow changes to AmForth's code.
