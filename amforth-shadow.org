...
<<HQ>> [[https://github.com/wexi/amforth-shadow][AmForth-Shadow]] is a sandbox for [[http://en.wikipedia.org/wiki/Atmel_AVR%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20][AVR8]] Forth development that is
...
+ #include vs. #install :: #include would skip uploading if the file has
     ...
     unconditional. [[HQ]] calls conditional file inclusion #require and
     unconditional inclusion #include. This is influenced by gforth. The
     Shadow (for now) will not follow suit.

+ <<create>> --capture :: Capture compiled word names.

+ <<conceal>> --conceal :: Substitute earlier captured word names with
     serial numbers.

+ <<log>> --log :: This option collects the actual code that it sent to
                   the AmForth system, comments free and following all
                   string substituion.
