...
Define the following macros in your application "template.asm" as your project ports/pins use. The following CTS/RTS/DTR controls are independent of each other -- you can implement any of them, none
or all. Note that RTS requires an edge sensitive interrupt input.
