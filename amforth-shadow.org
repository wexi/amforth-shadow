...
be changed in the process. For example, all the words which begin with gl-
are added to the graphic library word-list with this prefix removed.

It is recommended to include this wordlist-scope in every project:
lib/_local.frt
