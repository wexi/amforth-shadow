...
this code has an AmForth origin or not. While [[http://www.amazon.com/Intellectual-Property-Open-Source-Protecting/dp/0596517963][the Shadow questions this claim based on a reliable source]] the Shadow recommends to abide by Matthias expectations and solve pesky commercial situations
through obfuscation of the source code. See amforth-shell [[create][--create]], [[conceal][--conceal]] and [[log][--log]] options.
...
+ <<create>> Capture compiled word names.

+ <<conceal>> Substitute earlier captured word names with serial numbers.
