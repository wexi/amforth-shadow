...
independent [[http://amforth.sourceforge.net/][AmForth]] project fork since its trunk@1687 decision, where
AmForth has changed its software license from GPLv2 to GPLv3. Earlier to
that fork the AmForth project was fondly called "HQ" as there was still
some hope that AmForth would adopt some of AmForth-Shadow innovations.
