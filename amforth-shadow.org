...
- -! ( w addr -- ) :: [ASM] Subtracts w from the addressed word.

- +!@ ( w1 addr -- w2 ) :: [ASM] Adds w1 to the addressed word and return
     the word sum w2.

- c+! ( b addr -- ) :: [ASM] Adds b to the addressed byte.

- c-! ( b addr -- ) :: [ASM] Subtracts b from the addressed byte.

- c+!@ ( b1 addr -- b2 ) :: [ASM] Adds b1 to the addressed byte and return
     the byte sum b2.
