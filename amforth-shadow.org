...
*** DONE Automatic forward reference resolution

An alternative to the [[cookbook][cookbook]] approach is now being developed via
amforth-shell. The seed has been planted, see core/words/ldots.asm.
