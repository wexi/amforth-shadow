...
device.asm of interest. Also pass his core/dict 4k changes to your chosen
core size (2k or 8k).
...
* TODO Flash programming, faster and safer (experimental) 
...
when using full page buffers; Unsafe, since we erase the Flash 128 times
more than necessary while the Flash is only guaranteed for 10,000
erase/write cycles.
