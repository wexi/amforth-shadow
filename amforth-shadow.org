...
HQ now calls conditional file inclusion #require and unconditional
inclusion #include. This is influenced by gforth. The Shadow (for now) will
not follow suit for his deep rooted C language habits. Pragma: To maintain
compatibility with HQ #require
