...
* Reduce EEPROM based pointers wear out

EE_DP, EE_HERE and EE_EDP now have RAM_DP, RAM_HERE and RAM_EDP copies.  
Execute "eesy" to sync these EE pointers with their RAM copies. 
This is done for you automatically by tools/amforth-shell.py when you leave the program.
